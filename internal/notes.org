...
Create an event page on Lanyrd:

http://lanyrd.com/

Here's 2017:

http://lanyrd.com/2017/workshopfarm2017/

You can also put links to calls there.

More importantly, once the program is finalized, putting the program
on Lanyrd enables attendees to use the Lanyrd app to put together
their schedule.
