...
## FARM 2026 Call for Papers, Demos, and Performances

<img src="/files/farm-lambda-small.jpg" style="float: right; margin: 10px; width:30em" />

**24th August, 2026**, co-located with
[ICFP 2026](https://icfp26.sigplan.org/), held in Indianapolis, Indiana, USA.

### Key Dates

All deadlines are AoE (UTC-12h).

| Paper and demo submission deadline || June 1 |
| Performance submission deadline    || June 15 |
| Author notification                || June 15 |
| Camera-ready deadline              || July 7 |
| Workshop                           || August 24 |
...
Papers must be submitted via [HotCRP](https://farm26.hotcrp.com/), and meet the following requirements:

- 5 to 12 pages
- PDF format
- Adhere to the [ACM SIGPLAN template](https://www.sigplan.org/Resources/ProceedingsFormat/)

Accepted papers will be published in the ACM Digital Library as part of the FARM 2026 proceedings.
...
Demos must be submitted via [HotCRP](https://farm26.hotcrp.com/), and meet the following requirements:
...
Accepted demos will be published in the ACM Digital Library as part of the FARM 2026 proceedings.
...
Performance proposals should be submitted via
[HotCRP](https://farm26.hotcrp.com/), and must include:
...
For any questions, issues or comments, email `farm-2026@functional-art.org`.

## Workshop Organization

**General Chair**: [Mae Milano](https://www.languagesforsyste.ms/) (Princeton University)

**Performance Chair**: Tae Hong Park (Purdue University)
